...
public class MyListViewLetterActivity extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		personList = (ListView) findViewById(R.id.lvShow);
		personList.setAdapter(new ArrayAdapter<String>(this,
